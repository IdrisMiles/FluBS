#ifndef FLUIDPROPERTYWIDGETOLD_H
#define FLUIDPROPERTYWIDGETOLD_H
...
class FluidPropertyWidgetOld : public QWidget
{
    Q_OBJECT

public:
    FluidPropertyWidgetOld(QWidget *parent = nullptr);
    ~FluidPropertyWidgetOld();
...
#endif // FLUIDPROPERTYWIDGETOLD_H
