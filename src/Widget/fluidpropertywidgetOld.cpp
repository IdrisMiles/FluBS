...
FluidPropertyWidgetOld::FluidPropertyWidgetOld(QWidget *parent) : QWidget(parent)
{
...
FluidPropertyWidgetOld::~FluidPropertyWidgetOld()
{
...
void FluidPropertyWidgetOld::SetFluidProperty(std::shared_ptr<FluidProperty> _fluidProperty)
{
...
std::shared_ptr<FluidProperty> FluidPropertyWidgetOld::GetFluidProperty()
{
    return m_fluidProperty;
}


void FluidPropertyWidgetOld::UpdateFluidProperty()
{
...
void FluidPropertyWidgetOld::ResetSimBtnClicked()
{
    emit ResetSim();
}

void FluidPropertyWidgetOld::TogglePlaySimBtnClicked()
{
