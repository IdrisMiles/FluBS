...
distdir: FORCE
	...
	$(COPY_FILE) --parents include/boundary.h include/fluid.h include/fluidproperty.h include/fluidpropertywidget.h include/fluidsolverproperty.h include/fluidsystem.h include/mainwindow.h include/mesh.h include/meshloader.h include/openglscene.h include/rendermesh.h include/sphsolverGPU.h cuda_inc/smoothingKernel.cuh cuda_inc/sphsolver.cuh cuda_inc/vec_ops.cuh $(DISTDIR)/
	$(COPY_FILE) --parents src/boundary.cpp src/fluid.cpp src/fluidproperty.cpp src/fluidpropertywidget.cpp src/fluidsolverproperty.cpp src/fluidsystem.cpp src/main.cpp src/mainwindow.cpp src/meshloader.cpp src/openglscene.cpp src/rendermesh.cpp src/sphsolverGPU.cpp $(DISTDIR)/
