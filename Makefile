...
LIBS          = $(SUBLIBS) -L/usr/lib/x86_64-linux-gnu -L$(CUDA_PATH)/include/cuda -L/usr/local/lib -L/usr/lib -lGLU -lGLEW -L${HOME}/dev/lib -lassimp -lcudart -lcurand -L/home/idris/Qt5.7.0/5.7/gcc_64/lib -lQt5OpenGL -L/usr/lib64 -lQt5Widgets -lQt5Gui -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
cuda_obj/poly6kernel_cuda.o: cuda_inc/poly6kernel.cuh \
	...
	/usr/bin/nvcc -ccbin g++ -m64 -arch=sm_50 -c -o cuda_obj/poly6kernel_cuda.o cuda_src/poly6kernel.cu --use_fast_math -I/home/idris/uni/major/dev/include -I/usr/local/include -I/usr/include -I/home/idris/dev/include -I/home/idris/uni/major/dev/cuda_inc -I$(CUDA_PATH)/include -I$(CUDA_PATH)/include/cuda

cuda_obj/smoothingKernel_cuda.o: cuda_inc/smoothingKernel.cuh \
		cuda_src/smoothingKernel.cu
	/usr/bin/nvcc -ccbin g++ -m64 -arch=sm_50 -c -o cuda_obj/smoothingKernel_cuda.o cuda_src/smoothingKernel.cu --use_fast_math -I/home/idris/uni/major/dev/include -I/usr/local/include -I/usr/include -I/home/idris/dev/include -I/home/idris/uni/major/dev/cuda_inc -I$(CUDA_PATH)/include -I$(CUDA_PATH)/include/cuda

cuda_obj/smoothkernel_cuda.o: cuda_inc/smoothkernel.cuh \
		cuda_src/smoothkernel.cu
	/usr/bin/nvcc -ccbin g++ -m64 -arch=sm_50 -c -o cuda_obj/smoothkernel_cuda.o cuda_src/smoothkernel.cu --use_fast_math -I/home/idris/uni/major/dev/include -I/usr/local/include -I/usr/include -I/home/idris/dev/include -I/home/idris/uni/major/dev/cuda_inc -I$(CUDA_PATH)/include -I$(CUDA_PATH)/include/cuda

cuda_obj/sphGPU_cuda.o: include/sphGPU.h \
		cuda_inc/sphGPU_Kernels.cuh \
		cuda_src/sphGPU.cu
	/usr/bin/nvcc -ccbin g++ -m64 -arch=sm_50 -c -o cuda_obj/sphGPU_cuda.o cuda_src/sphGPU.cu --use_fast_math -I/home/idris/uni/major/dev/include -I/usr/local/include -I/usr/include -I/home/idris/dev/include -I/home/idris/uni/major/dev/cuda_inc -I$(CUDA_PATH)/include -I$(CUDA_PATH)/include/cuda

cuda_obj/sphGPU_Kernels_cuda.o: cuda_inc/sphGPU_Kernels.cuh \
		cuda_src/sphGPU_Kernels.cu
	/usr/bin/nvcc -ccbin g++ -m64 -arch=sm_50 -c -o cuda_obj/sphGPU_Kernels_cuda.o cuda_src/sphGPU_Kernels.cu --use_fast_math -I/home/idris/uni/major/dev/include -I/usr/local/include -I/usr/include -I/home/idris/dev/include -I/home/idris/uni/major/dev/cuda_inc -I$(CUDA_PATH)/include -I$(CUDA_PATH)/include/cuda

cuda_obj/sphsolverGPU_cuda.o: include/sphsolverGPU.h \
		include/fluidproperty.h \
		include/fluidsolverproperty.h \
		cuda_src/sphsolverGPU.cu
	/usr/bin/nvcc -ccbin g++ -m64 -arch=sm_50 -c -o cuda_obj/sphsolverGPU_cuda.o cuda_src/sphsolverGPU.cu --use_fast_math -I/home/idris/uni/major/dev/include -I/usr/local/include -I/usr/include -I/home/idris/dev/include -I/home/idris/uni/major/dev/cuda_inc -I$(CUDA_PATH)/include -I$(CUDA_PATH)/include/cuda

cuda_obj/spikykernel_cuda.o: cuda_inc/spikykernel.cuh \
		cuda_src/spikykernel.cu
	/usr/bin/nvcc -ccbin g++ -m64 -arch=sm_50 -c -o cuda_obj/spikykernel_cuda.o cuda_src/spikykernel.cu --use_fast_math -I/home/idris/uni/major/dev/include -I/usr/local/include -I/usr/include -I/home/idris/dev/include -I/home/idris/uni/major/dev/cuda_inc -I$(CUDA_PATH)/include -I$(CUDA_PATH)/include/cuda

cuda_obj/vec_ops_cuda.o: cuda_inc/vec_ops.cuh \
		cuda_src/vec_ops.cu
	/usr/bin/nvcc -ccbin g++ -m64 -arch=sm_50 -c -o cuda_obj/vec_ops_cuda.o cuda_src/vec_ops.cu --use_fast_math -I/home/idris/uni/major/dev/include -I/usr/local/include -I/usr/include -I/home/idris/dev/include -I/home/idris/uni/major/dev/cuda_inc -I$(CUDA_PATH)/include -I$(CUDA_PATH)/include/cuda
