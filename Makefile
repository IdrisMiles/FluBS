...
INCPATH       = -I. -Iinclude -isystem /usr/local/include -isystem /usr/include -Icuda_inc -I$(CUDA_PATH)/include -I$(CUDA_PATH)/include/cuda -I../../../Qt5.7.0/5.7/gcc_64/include -I../../../Qt5.7.0/5.7/gcc_64/include/QtOpenGL -I../../../Qt5.7.0/5.7/gcc_64/include/QtWidgets -I../../../Qt5.7.0/5.7/gcc_64/include/QtGui -I../../../Qt5.7.0/5.7/gcc_64/include/QtCore -Imoc -Iui -I../../../Qt5.7.0/5.7/gcc_64/mkspecs/linux-g++
...
DISTDIR = /home/idris/uni/major/dev/obj/qtOpenGL1.0.0
LINK          = g++
LFLAGS        = -Wl,-rpath,/home/idris/Qt5.7.0/5.7/gcc_64/lib
LIBS          = $(SUBLIBS) -L/usr/lib/x86_64-linux-gnu -L$(CUDA_PATH)/include/cuda -L/usr/local/lib -L/usr/lib -lGLU -lGLEW -lcudart -lcurand -L/home/idris/Qt5.7.0/5.7/gcc_64/lib -lQt5OpenGL -L/usr/lib64 -lQt5Widgets -lQt5Gui -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
distdir: FORCE
	...
	$(COPY_FILE) --parents include/abstractSphSolver.h include/fluid.h include/fluidproperty.h include/fluidpropertywidget.h include/mainwindow.h include/openglscene.h include/sphsolverCPU.h include/sphsolverGPU.h cuda_inc/sphsolver.cuh $(DISTDIR)/
	$(COPY_FILE) --parents src/abstractSphSolver.cpp src/fluid.cpp src/fluidproperty.cpp src/fluidpropertywidget.cpp src/main.cpp src/mainwindow.cpp src/openglscene.cpp src/sphsolverCPU.cpp src/sphsolverGPU.cpp $(DISTDIR)/
...
cuda_obj/sphsolverGPU_cuda.o: include/sphsolverGPU.h \
	...
	/usr/bin/nvcc -ccbin g++ -m64 -arch=sm_50 -c -o cuda_obj/sphsolverGPU_cuda.o cuda_src/sphsolverGPU.cu --use_fast_math -I/home/idris/uni/major/dev/include -I/usr/local/include -I/usr/include -I/home/idris/uni/major/dev/cuda_inc -I$(CUDA_PATH)/include -I$(CUDA_PATH)/include/cuda
