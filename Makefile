...
SOURCES       = src/heterocont.cpp \
		...
		src/Fluid/fluid.cpp \
		src/Fluid/fluidproperty.cpp \
		src/Rigid/boundary.cpp \
		src/SPH/sph.cpp \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents include/heterocont.h include/mainwindow.h include/openglscene.h include/MeshSampler/barycoordmeshsampler.h include/MeshSampler/meshsampler.h include/MeshSampler/poissondiskpointset.h include/Mesh/mesh.h include/Mesh/meshloader.h include/Mesh/rendermesh.h include/FluidSystem/fluidsolverproperty.h include/FluidSystem/fluidsystem.h include/Fluid/fluid.h include/Fluid/fluidproperty.h include/Rigid/boundary.h include/SPH/sph.h include/SPH/sphGPU.h include/Widget/fluidpropertywidget.h cuda_inc/poly6kernel.cuh cuda_inc/smoothingKernel.cuh cuda_inc/smoothkernel.cuh cuda_inc/sphGPU_Kernels.cuh cuda_inc/spikykernel.cuh cuda_inc/vec_ops.cuh $(DISTDIR)/
	$(COPY_FILE) --parents src/heterocont.cpp src/main.cpp src/mainwindow.cpp src/openglscene.cpp src/MeshSampler/barycoordmeshsampler.cpp src/MeshSampler/poissondiskpointset.cpp src/Mesh/meshloader.cpp src/Mesh/rendermesh.cpp src/FluidSystem/fluidsolverproperty.cpp src/FluidSystem/fluidsystem.cpp src/Fluid/fluid.cpp src/Fluid/fluidproperty.cpp src/Rigid/boundary.cpp src/SPH/sph.cpp src/Widget/fluidpropertywidget.cpp $(DISTDIR)/
...
obj/fluid.o: src/Fluid/fluid.cpp include/Fluid/fluid.h \
		include/Fluid/fluidproperty.h \
		include/FluidSystem/fluidsolverproperty.h \
		../../../Qt5.7.0/5.7/gcc_64/include/QtGui/QOpenGLShaderProgram \
		../../../Qt5.7.0/5.7/gcc_64/include/QtGui/qopenglshaderprogram.h \
		...
		../../../Qt5.7.0/5.7/gcc_64/include/QtGui/qwindowdefs.h \
		../../../Qt5.7.0/5.7/gcc_64/include/QtGui/qwindowdefs_win.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o obj/fluid.o src/Fluid/fluid.cpp

obj/fluidproperty.o: src/Fluid/fluidproperty.cpp include/Fluid/fluidproperty.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o obj/fluidproperty.o src/Fluid/fluidproperty.cpp

obj/boundary.o: src/Rigid/boundary.cpp include/Rigid/boundary.h \
		../../../Qt5.7.0/5.7/gcc_64/include/QtGui/QOpenGLShaderProgram \
		../../../Qt5.7.0/5.7/gcc_64/include/QtGui/qopenglshaderprogram.h \
		../../../Qt5.7.0/5.7/gcc_64/include/QtCore/qglobal.h \
		../../../Qt5.7.0/5.7/gcc_64/include/QtCore/qconfig.h \
		...
		include/FluidSystem/fluidsolverproperty.h \
		include/Mesh/mesh.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o obj/boundary.o src/Rigid/boundary.cpp
...
obj/fluidpropertywidget.o: src/Widget/fluidpropertywidget.cpp 
