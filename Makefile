...
SOURCES       = src/boundary.cpp \
		...
		src/openglscene.cpp \
		src/rendermesh.cpp \
		src/sph.cpp moc/moc_fluidpropertywidget.cpp \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents include/boundary.h include/fluid.h include/fluidproperty.h include/fluidpropertywidget.h include/fluidsolverproperty.h include/fluidsystem.h include/heterocont.h include/mainwindow.h include/mesh.h include/meshloader.h include/openglscene.h include/rendermesh.h include/sph.h include/sphGPU.h cuda_inc/poly6kernel.cuh cuda_inc/smoothingKernel.cuh cuda_inc/smoothkernel.cuh cuda_inc/sphGPU_Kernels.cuh cuda_inc/spikykernel.cuh cuda_inc/vec_ops.cuh $(DISTDIR)/
	$(COPY_FILE) --parents src/boundary.cpp src/fluid.cpp src/fluidproperty.cpp src/fluidpropertywidget.cpp src/fluidsolverproperty.cpp src/fluidsystem.cpp src/heterocont.cpp src/main.cpp src/mainwindow.cpp src/meshloader.cpp src/openglscene.cpp src/rendermesh.cpp src/sph.cpp $(DISTDIR)/
