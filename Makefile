...
cuda_obj/sphsolverGPU_cuda.o: include/sphsolverGPU.h \
	...
	/usr/bin/nvcc -m64 -arch=sm_50 -c -o cuda_obj/sphsolverGPU_cuda.o cuda_src/sphsolverGPU.cu -ccbin g++ --use_fast_math -I/home/idris/uni/major/dev/include -I/usr/local/include -I/usr/include -I/home/idris/dev/include -I/home/idris/uni/major/dev/cuda_inc -I$(CUDA_PATH)/include -I$(CUDA_PATH)/include/cuda
